...
<div class="container-center">
    ...
    <a class="button" href="${pageContext.request.contextPath}/Controller?command=logout">log out</a>
    <hr/>
    <div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body bg-danger">
                        <a class="button"
                           href="${pageContext.request.contextPath}/Controller?command=show_user_station&id=1">Red
                            station</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body bg-success">
                        <a class="button"
                           href="${pageContext.request.contextPath}/Controller?command=show_user_station&id=2">Green
                            station</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body bg-info">
                        <a class="button"
                           href="${pageContext.request.contextPath}/Controller?command=show_user_station&id=3">Blue
                            station</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body bg-dark">
                        <a class="button"
                           href="${pageContext.request.contextPath}/Controller?command=show_user_station&id=4">Black
                            station</a>
                    </div>
                </div>
            </div>
